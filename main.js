    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4 font-sans">
      ...
      <div className="w-full max-w-3xl grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
          <div className="bg-gradient-to-r from-itd-blue to-itd-red h-1.5"></div>
          <div className="p-6 flex flex-col flex-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-itd-blue/10 flex items-center justify-center flex-shrink-0">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden flex flex-col">
          <div className="bg-gradient-to-r from-itd-red to-itd-blue h-1.5"></div>
          <div className="p-6 flex flex-col flex-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-lg bg-itd-red/10 flex items-center justify-center flex-shrink-0">
                ...
                <>
                  ...
                  {mostrarInputBypass && (
                    <div className="border border-gray-200 rounded-lg p-3 bg-gray-50 space-y-2">
                      ...
                      {errorBypass && <p className="text-[10px] text-red-500 font-medium">Contraseña incorrecta.</p>}
                    </div>
                  )}
                </>
              )}
